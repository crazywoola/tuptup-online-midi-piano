...
const COPY = {
  zh: {
    ...
    quickSteps: [
      ...
      ["04", "编辑与播放歌曲", "按键会按所选步长写入并自动前进。按 Space 播放完整歌曲；也可点“随机灵感”生成两小节素材，再框选、拖动、量化或继续修改。"],
    ],
  ...
  en: {
    ...
    quickSteps: [
      ...
      ["04", "Edit and play the song", "Notes enter at the chosen length and advance the playhead. Use Random Idea for a two-bar starting point, press Space to play, then select, drag, quantize, or refine it."],
    ],
