...
const COPY = {
  zh: {
    ...
    quickSteps: [
      ...
      ["04", "编辑与播放歌曲", "按键会按所选步长写入并自动前进。按 Space 播放完整歌曲；音符可框选、拖动、缩放、量化、复制或删除。"],
    ],
    ...
    methods: [
      ...
      ["编辑", "手动画入", "适合修补与精确编排", "选铅笔后点击空白，或双击网格添加音符。选择工具可框选；音符可整组拖动、右侧缩放、转调、微移、量化、人性化、复制或删除。"],
    ],
    ...
    zones: [
      ...
      ["02", "上方 · 编曲时间线", "缩放和滚动完整歌曲；管理音轨与多个 Clip，并设置网格、拍号、播放跟随和独立循环范围。"],
      ["03", "中部 · 钢琴卷帘", "只编辑当前 Clip：框选、多音符拖动/缩放、力度、量化强度、人性化与可选步长都在这里。"],
  ...
  en: {
    ...
    quickSteps: [
      ...
      ["04", "Edit and play the song", "Notes enter at the chosen length and advance the playhead. Press Space for the full song; marquee, drag, resize, quantize, duplicate, or delete notes."],
    ],
    ...
    methods: [
      ...
      ["Editing", "Draw Notes", "Repair and arrange with precision", "Choose Pencil and click, or double-click the grid. Select mode supports marquee; drag or resize groups, transpose, nudge, quantize, humanize, duplicate, or delete."],
    ],
    ...
    zones: [
      ...
      ["02", "Top · Arrangement", "Zoom and scroll the full song; manage tracks and clips, grid, meter, follow mode, and an independent loop range."],
      ["03", "Middle · Piano Roll", "Edit only the active clip with marquee, group drag/resize, velocity, quantize strength, humanize, and selectable step lengths."],
